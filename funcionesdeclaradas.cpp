...
string PreguntoNombreJugador1 (){
  ...
  cout << endl;
  cin>> jugador1;
  cout << "Â¡Bienvenido/a " << jugador1 << "!"<<endl;
  system("pause");
  system ("cls");
...
string PreguntoNombreJugador2 (){
  ...
  cout << endl;
  cin>> jugador2;
  cout << "Â¡Bienvenido/a " << jugador2 << "!"<<endl;
  system("pause");
  system ("cls");

  return jugador2;
}
// asignar dados stock (arreglar porque no siempre seran 6)
...
//cuento cuantos dados stock se eligieron en la jugada exitosa
...
void Rondas(string& jugador1, string& jugador2, int n, int &puntaje1, int &puntaje2){
    ...
    dadosElegidos.clear();
    //si el jugador que arranca la ronda ya no tiene dados entonces el juego termina
    ...
    //valor del numero objetivo
        ...
        cout<<endl;
        cout<<endl;
        cout<<"Jugador     "<<"Puntos      "<<"Dados stock"<<endl;
        cout<<endl;
        cout<<jugador1<<"   "<<puntaje1<<"   "<<cantDadosStock1<<endl;
        cout<<endl;
        cout<<jugador2<<"   "<<puntaje2<<"   "<<cantDadosStock2<<endl;
        cout<<endl;
        cout<<endl;
         ...
         cout << endl;
          ...
          if (primerlanzamiento1 == primerlanzamiento2){
            ...
            if (primerlanzamiento1<primerlanzamiento2) {
                ...
                cout << endl;
                cout << endl;
                cout << "Â¡"<<ganador << " DARA INICIO A LA PARTIDA!" << endl;
                cout << endl;
                system ("pause");
                for(int i=1; i<4;i++){
